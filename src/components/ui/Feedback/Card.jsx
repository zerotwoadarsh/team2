    ...
    <div className="flex flex-col overflow-hidden transition-transform transform bg-white shadow-lg rounded-xl hover:-translate-y-2 hover:shadow-2xl">
      <div className="w-full h-72">
        <div className="p-6">
          ...
          <p className="mt-2 text-base text-gray-600">{discription}</p>
        </div>
        <a
          href={FIR}
          className="inline-block px-4 py-2 mt-4 mb-4 ml-6 font-medium text-center text-white transition-colors duration-300 bg-green-600 rounded-lg hover:bg-green-700"
          target="_blank"
